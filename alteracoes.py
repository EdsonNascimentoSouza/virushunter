...
class Fase1(Fase):
    ...
    def criar_virus(self):
        ...
        self.virus_lista = [
            Virus(385, 450, 150, 400, ARMA_PEDRA, self.audio), #virus2
            Virus(950, 570, 700, 1100,  ARMA_PEDRA, self.audio), #virus3
            Virus(1700, 620, 1300, 1700,  ARMA_PEDRA, self.audio), #virus4
            Virus(900, 265, 700, 1000,  ARMA_PEDRA, self.audio), #virus5
            Virus(1600, 370, 1450, 1670,  ARMA_PEDRA, self.audio), #virus6
            Virus(1000, 720, 50, 1000,  ARMA_PEDRA, self.audio) #virus1
